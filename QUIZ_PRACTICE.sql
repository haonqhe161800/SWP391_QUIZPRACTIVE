...
insert into [Subject] values ('C', './assets/images/categories/C.png', 0, 'C - Ngôn ngữ cơ bản cho người mới bắt đầu', 'Hiểu và áp dụng những kiến thức nền tảng cần thiết cho developer'),
							 ('C++', './assets/images/categories/C++.png',0, 'C++ - Ngôn ngữ cơ bản cho người mới bắt đầu', 'Hiểu và áp dụng những kiến thức nền tảng cần thiết cho developer'),
							 ('C#', './assets/images/categories/CSharp.png' ,0, 'C# - Ngôn ngữ cơ bản cho người mới bắt đầu', 'Hiểu và áp dụng những kiến thức nền tảng cần thiết cho developer'),
							 ('Java', './assets/images/categories/Java.png',0, 'Java - Ngôn ngữ cơ bản cho người mới bắt đầu', 'Hiểu và áp dụng những kiến thức nền tảng cần thiết cho developer'),
							 ('Javascript', './assets/images/categories/Javascript.png',0, 'Javascript - Ngôn ngữ cơ bản cho người mới bắt đầu', 'Hiểu và áp dụng những kiến thức nền tảng cần thiết cho developer'),
							 ('Python', './assets/images/categories/Python.png',0, 'Python - Ngôn ngữ cơ bản cho người mới bắt đầu', 'Hiểu và áp dụng những kiến thức nền tảng cần thiết cho developer')
...
INSERT INTO [dbo].[Blog]([blog_name],[subject_id])VALUES(N'What is language program C?',1);
INSERT INTO [dbo].[Blog]([blog_name],[subject_id])VALUES(N'What is C++ programming language?',2);
INSERT INTO [dbo].[Blog]([blog_name],[subject_id])VALUES(N'What is C#? Learn about C# programming language',3);
INSERT INTO [dbo].[Blog]([blog_name],[subject_id])VALUES(N'What is Java programming language? How important is Java?',4);
INSERT INTO [dbo].[Blog]([blog_name],[subject_id])VALUES(N'What is JavaScript?',5);
INSERT INTO [dbo].[Blog]([blog_name],[subject_id])VALUES(N'What is Python?',6);
GO

--DELETE FROM Post

INSERT INTO [dbo].[Post]([marketer_id],[blog_id],[image],[content],[short_content],[status])VALUES
           (1,1,'313920073_510188231031083_8451312006797281979_n.jpg',N'The C programming language is an imperative language developed in the early 1970s by Dennis Ritchie for use in the UNIX operating system.  Since then, this language has spread to many other operating systems and has become one of the most popular languages.  C is the most efficient and preferred language for writing system software, although it is also used for writing applications.  In addition, C is also often used as a teaching medium in computer science, although the language is not designed for beginners.<br>
...
','In 1979, C++ was developed by Bjarne Stroustrup at Bell Labs based on the C language.',1)


INSERT INTO [dbo].[Post]([marketer_id],[blog_id],[image],[content],[short_content],[status])VALUES(1,3,'313920073_510188231031083_8451312006797281979_n.jpg',N'<h2 ><strong>What is C#?</strong></h2><p>C# (or C sharp) is a simple programming language, developed by Microsoft engineers in 2000. C# is modern, object-oriented programming language built on the foundation of two of the most powerful languages, C++ and Java.</p>
...
','For ITers or those who major in Information Technology, there is no one who does not know the Java programming language.',1)


INSERT INTO [dbo].[Post]([marketer_id],[blog_id],[image],[content],[short_content],[status])VALUES(1,5,'313920073_510188231031083_8451312006797281979_n.jpg',N'<p _msttexthash="11665030" _msthash="26"><strong _istranslated="1">JavaScript</strong> has been the most popular programming language in the world for the past 20 years. It is also one of the 3 main languages of web programming:</p>
<ol>
...
</ul>','Python is a high-level computer programming language commonly used to build websites and software, automate tasks, and conduct data analysis.',1)
