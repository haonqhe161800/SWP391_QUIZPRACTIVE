        ...
        <div style="padding: 0 300px; margin-bottom: 100px">
            <div class="content_exam">
                ...
                <div style="margin-bottom: 30px">
                    <p style="margin-bottom: 20px"><span class="number"><%=j%>. </span><%=question.getQuestion_name()%></p>
                    ...
                    <div class="exam-items">
                        ...
                        <input readonly="" class="result" value="<%=er.getIs_correct()%>" type="radio" checked><span style="margin-left: 4px"><%=er.getAnswer_name()%></span><br>
                    </div>
                    <%} else {%>
                    <div class="exam-items">
                        <span id="icon_<%=i%>"></span>
                        <input  readonly="" class="result" value="<%=er.getIs_correct()%>" type="radio"><span style="margin-left: 4px"><%=er.getAnswer_name()%></span><br>
                    </div>
                    <%}
                }
            }%>
